...
main()
{
	...
	case $PROFILE_OPTION in
		1)  java -jar target/robipozzi-kafka-consumer-java-0.0.1-SNAPSHOT.jar
			;;
        2)  java -jar target/robipozzi-kafka-consumer-java-0.0.1-SNAPSHOT.jar --spring.profiles.active=confluent
            ;;
